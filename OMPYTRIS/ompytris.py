...
next_mino3 = randint(1, 7)  # Next mino3
    ...
    # Game screen
        ...
        for event in pygame.event.get():
            ...
            if event.type == QUIT:
                ...
                draw_multiboard(next_mino1, next_mino2, next_mino3, hold_mino, next_mino1_2P, next_mino2_2P,
                                next_mino3_2P, hold_mino_2P, score, level, goal)
