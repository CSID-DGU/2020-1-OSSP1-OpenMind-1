...
single_button = button(board_width * 0.6, board_height * 0.15, int(board_width * 0.3734), int(board_height * 0.1777), 1,
                       single_button_image)

pvp_button = button(board_width * 0.6, board_height * 0.35, int(board_width * 0.3734), int(board_height * 0.1777), 2,
                    pvp_button_image)

help_button = button(board_width * 0.6, board_height * 0.55, int(board_width * 0.3734), int(board_height * 0.1777), 3,
                     help_button_image)

quit_button = button(board_width * 0.6, board_height * 0.75, int(board_width * 0.3734), int(board_height * 0.1777), 4,
                     quit_button_image)

setting_icon = button(board_width * 0.02, board_height * 0.75, int(board_height * 0.23), int(board_height * 0.23), 5,
                      setting_vector)

leaderboard_icon = button(board_width * 0.02, board_height * 0.5, int(board_height * 0.23), int(board_height * 0.23), 6,
                          leaderboard_vector)

resume_button = button(board_width * 0.324, board_height * 0.15, int(board_width * 0.3734), int(board_height * 0.1777),
                       1, resume_button_image)
restart_button = button(board_width * 0.324, board_height * 0.35, int(board_width * 0.3734), int(board_height * 0.1777),
                        1, restart_button_image)
setting_button = button(board_width * 0.324, board_height * 0.55, int(board_width * 0.3734), int(board_height * 0.1777),
                        1, setting_button_image)
pause_quit_button = button(board_width * 0.324, board_height * 0.75, int(board_width * 0.3734),
                           int(board_height * 0.1777), 1, quit_button_image)

back_button = button(board_width * 0.324, board_height * 0.75, int(board_width * 0.3734), int(board_height * 0.1777), 1,
                     back_button_image)

volume_icon = button(board_width * 0.25, board_height * 0.3, int(board_height * 0.23), int(board_height * 0.23), 5,
                     volume_vector)

screen_icon = button(board_width * 0.45, board_height * 0.3, int(board_height * 0.23), int(board_height * 0.23), 6,
                     screen_vector)

keyboard_icon = button(board_width * 0.65, board_height * 0.3, int(board_height * 0.23), int(board_height * 0.23), 6,
                       keyboard_vector)

ok_button = button(board_width * 0.324, board_height * 0.75, int(board_width * 0.3734), int(board_height * 0.1777), 1,
                   ok_button_image)

menu_button = button(board_width * 0.324, board_height * 0.15, int(board_width * 0.3734), int(board_height * 0.1777), 1,
                     menu_button_image)

gameover_quit_button = button(board_width * 0.324, board_height * 0.35, int(board_width * 0.3734),
                              int(board_height * 0.1777), 1, quit_button_image)
...
# Draw game screen
def draw_board(next1, next2, next3, hold, score, level, goal):
    ...
    #grid_n3 = tetrimino.mino_map[next3 - 1][0]

    for i in range(4):
        for j in range(4):
            dx1 = int(board_width * 0.045) + sidebar_width + block_size * j
            dy1 = int(board_height * 0.3743) + block_size * i
            if grid_n1[i][j] != 0:
                draw_block(dx1, dy1, ui_variables.t_color[grid_n1[i][j]])

    #for i in range(4):
    #    for j in range(4):
    #        dx2 = int(board_width * 0.185) + sidebar_width + block_size * j
    #        dy2 = int(board_height * 0.3743) + block_size * i
    #        if grid_n2[i][j] != 0:
    #            draw_block(dx2, dy2, ui_variables.t_color[grid_n2[i][j]])

    #for i in range(4):
    #    for j in range(4):
    #        dx3 = int(board_width * 0.325) + sidebar_width + block_size * j
    #        dy3 = int(board_height * 0.3743) + block_size * i
    #        if grid_n3[i][j] != 0:
    #            draw_block(dx3, dy3, ui_variables.t_color[grid_n3[i][j]])
...
def draw_1Pboard(next1, next2, next3, hold, score, level, goal):
...
def draw_2Pboard(next1, next2, next3, hold, score, level, goal):
...
def draw_multiboard(next1_1P, next2_1P, next3_1P, hold_1P, next1_2P, next2_2P, next3_2P, hold_2P, score, level, goal):
    screen.fill(ui_variables.real_white)
    draw_1Pboard(next1_1P, next2_1P, next3_1P, hold_1P, score, level, goal)
    draw_2Pboard(next1_2P, next2_2P, next3_2P, hold_2P, score, level, goal)
...
while not done:
    ...
    if setting:
        ...
        if start:
            ...
            draw_board(next_mino1, next_mino2, next_mino3, hold_mino, score, level, goal)
    ...
    # Game screen
            ...
            if event.type == QUIT:
                ...
                if erase_count >= 1:
                    ...
                    if erase_count == 1:
                        ...
                        ui_variables.double_sound.play()
                        score += 150 * level * erase_count + combo_count
                    elif erase_count == 3:
                        ui_variables.break_sound.play()
                        ui_variables.triple_sound.play()
                        ui_variables.triple_sound.play()
                        ui_variables.triple_sound.play()
                        score += 350 * level * erase_count + combo_count
                    elif erase_count == 4:
                        ui_variables.break_sound.play()
                        ...
                        ui_variables.tetris_sound.play()
                        ui_variables.tetris_sound.play()
                        score += 1000 * level * erase_count + combo_count

                    for i in range(1, 11):
                        if combo_count == i:  # 1 ~ 10 콤보 이미지
                            screen.blit(ui_variables.large_combos[i - 1],
                                        (board_width * 0.324, board_height * 0.35))  # blits the combo number
                        elif combo_count > 10:  # 11 이상 콤보 이미지
                            screen.blit(ui_variables.tetris4,
                                        (board_width * 0.324, board_height * 0.35))  # blits the combo number
        ...
        for event in pygame.event.get():
            ...
            if event.type == QUIT:
                ...
                draw_multiboard(next_mino1, next_mino2, next_mino3, hold_mino, next_mino1_2P, next_mino2_2P, next_mino3_2P, hold_mino_2P, score, level, goal)
